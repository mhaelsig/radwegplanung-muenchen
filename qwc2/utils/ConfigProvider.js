export default {
    mhcGoogle: {
        url: '//mt1.google.com/vt/lyrs=m&x={x}&y={y}&z={z}',
        options: {
            maxZoom: 19,
    ...
    bergfex: {
        url: '//maps.bergfex.at/osm/standard/{z}/{x}/{y}.jpg',
        options: {
            attribution: 'Map data: &copy; <a href="http://www.bergfex.at">bergfex</a> contributors'
        }
    },
    OSM2World: {
        url: '//tiles.osm2world.org/tiles/n/{z}/{x}/{y}.png',
        options: {
            attribution:
                'Map data {attribution.OpenStreetMap}' + '<a href="http://maps.osm2world.org/about/">About OSM2World'
        }
    },
    MapBoxStyle: {
        url: '//api.mapbox.com/styles/v1/mapbox/{source}/tiles/256/{z}/{x}/{y}?access_token={accessToken}',
        options: {
            attribution:
    ...
    OpenRailwayMap: {
        url: '//{s}.tiles.openrailwaymap.org/standard/{z}/{x}/{y}.png',
        options: {
            maxZoom: 19,
    ...
    OpenFireMap: {
        url: '//openfiremap.org/hytiles/{z}/{x}/{y}.png',
        options: {
            maxZoom: 19,
    ...
    CyclOSM: {
        url: '//dev.{s}.tile.openstreetmap.fr/cyclosm/{z}/{x}/{y}.png',
        options: {
            maxZoom: 20,
    ...
    OpenMapSurfer: {
        url: '//maps.heigit.org/openmapsurfer/tiles/{variant}/webmercator/{z}/{x}/{y}.png',
        options: {
            maxZoom: 19,
            variant: 'roads',
    ...
    NLS: {
        ...
        variants: {
            ...
            OS_1920: 'nls',
            OS_opendata: {
                url: '//geo.nls.uk/maps/opendata/{z}/{x}/{y}.png',
                options: {
                    maxZoom: 16
                }
            },
            ...
            OS_6inch_1st: {
                url: '//geo.nls.uk/maps/os/six_inch/{z}/{x}/{y}.png',
                options: {
                    tms: true,
                    minZoom: 6,
                    maxZoom: 16,
            ...
            OS_npe: {
                url: '//geo.nls.uk/maps/os/newpopular/{z}/{x}/{y}.png',
                options: {
                    tms: true,
                    minZoom: 3,
                    maxZoom: 15
